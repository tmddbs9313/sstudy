...
public class Application02 {
    public static void main(String[] args) {
        ...
        System.out.println("카테고리 코드를 입력해주세여 : ");
        int categoryCode = sc.nextInt();
        System.out.println("판매여부를 결정해주세요(Y/N) : ");
        sc.nextInt();
        String OrderableStatus = sc.nextLine().toUpperCase();  // toUpperCase= 자동으로 대문자

        MenuDTO newMenu = new MenuDTO();
        newMenu.setMenuName(menuName);
        newMenu.setMenuPirce(menuPrice);
        ...
        try {
            ...
            pstmt.setInt(2, newMenu.getMenuPirce());
