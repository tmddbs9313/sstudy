...
public class Application {
    public static void main(String[] args) {
        ...
        int maxMenuCode = registDAO.selectLastMenuCode(con); //dao 안에있는 메소드 호출 . 을 쓰면 원하는거 호출가능.
        ...
        System.out.println("등록메뉴의 카테고리를 입력해주세요 : ");
        sc.nextLine();
        ...
        int categoryCode = 0;  //카테고리코드를 문자열로 잡아놧기때문에
        ...
        if(result > 0) {
            ...
            System.out.println("신규메뉴 등록 실패...ㅠ");
        }
